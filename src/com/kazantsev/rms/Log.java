...
public final class Log {
    ...
    private static boolean printToDocument = true;

    private static boolean printToConsoleBeforeStop = true;
    private static boolean printToFileBeforeStop = true;
    private static boolean printToDocumentBeforeStop = true;
